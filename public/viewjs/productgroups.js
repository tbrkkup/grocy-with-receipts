...
var productGroupsBulkSelect = new Grocy.Components.BulkSelect({
	tableSelector: "#productgroups-table",
...
{
	var objectIds = productGroupsBulkSelect.GetSelectedIds();
	...
	bootbox.confirm({
		...
		callback: function (result)
		{
			if (result === true)
			{
				Grocy.Api.Delete("objects/product_groups/bulk", { object_ids: objectIds },
