...
@if($mode == 'edit')
@section('title', $__t('Edit equipment group'))
@else
@section('title', $__t('Create equipment group'))
@endif
...
<div class="row">
	<div class="col-lg-6 col-12">
		...
		<form id="equipment-group-form"
			...
			'entity' => 'equipment_groups'
			))

			<button id="save-equipment-group-button"
